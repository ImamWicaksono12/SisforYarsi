...
<div class="container py-5">
    ...
    <div class="row mb-4 g-3 align-items-center">
        <div class="col-md-7 d-flex gap-2 overflow-auto pb-2">
            ...
            <div class="filter-pill">Akademik</div>
            <div class="filter-pill">Non-Akademik</div>
            <div class="filter-pill">Bantuan Dana</div>
        </div>
        <div class="col-md-5">
    ...
    <div class="row g-4">
        <div class="col-md-6 col-lg-4">
            <div class="card scholarship-card h-100 p-4 position-relative">
                ...
                <div class="mt-auto">
                    ...
                    <div class="d-grid">
                        <a href="#" class="btn btn-primary rounded-pill fw-bold">Daftar Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card scholarship-card h-100 p-4 position-relative border-start border-primary border-5">
                ...
                <h5 class="fw-bold mb-2">Beasiswa Yayasan Yarsi</h5>
                ...
                <div class="mt-auto">
                    ...
                    <div class="d-grid">
                        <a href="#" class="btn btn-outline-primary rounded-pill fw-bold">Detail Info</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card scholarship-card h-100 p-4 position-relative">
                ...
                <h5 class="fw-bold mb-2">Bantuan KIP Kuliah</h5>
                ...
                <div class="mt-auto">
                    ...
                    <div class="d-grid">
                        <button class="btn btn-light rounded-pill fw-bold" disabled>Belum Dibuka</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="text-center mt-5">
        <p class="text-muted small">Butuh bantuan pendaftaran? <a href="#" class="fw-bold">Hubungi Admin</a></p>
    </div>
</div>
